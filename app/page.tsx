    ...
    <div className="font-sans text-xl leading-relaxed text-center">
      <main className="flex flex-col items-center gap-8">
        ...
        <h1 className="max-w-4xl px-4 text-4xl md:text-4xl">
          <b>La Forge au fil du temps</b> est une association dont le but est de sauvegarder, de
          valoriser et d'animer le site des anciennes Forges de Bourzolles à Souillac.
        </h1>
      </main>
    </div>
  );
